# GoKit CLI  [![Build Status](https://travis-ci.org/wanmendaxue/kit.svg?branch=master)](https://travis-ci.org/wanmendaxue/kit)[![Go Report Card](https://goreportcard.com/badge/github.com/wanmendaxue/kit)](https://goreportcard.com/report/github.com/wanmendaxue/kit)[![Coverage Status](https://coveralls.io/repos/github/wanmendaxue/kit/badge.svg?branch=master)](https://coveralls.io/github/wanmendaxue/kit?branch=master)
...
```bash
go get github.com/wanmendaxue/kit
```
# Usage
```bash
kit help
